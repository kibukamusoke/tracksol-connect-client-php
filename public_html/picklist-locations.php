...
if(isset($_GET['idx']) && $_GET['action']) { //destroy location
    if($_GET['action'] == 'deactivate'){
        $data = array('idx' => (int)$_GET['idx']);
        $data['status'] = 9;
        $upsert = $__PICKLIST->upsertLocation($data);
        if($upsert['success']) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">locations</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="sparkline13-list shadow-reset">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Picklist <span class="table-project-n">locations</span></h1>
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tr>
                                    ...
                                    <th data-field="locationname" data-editable="true">Location Name / Code</th>
                                ...
                                <tbody>
                                <?php
                                $query = $__DB->select($_CLASSES['TABLES']['picklistLocation'], '`*`', '`status` = 0', 'updatedAt DESC');
                                while ($result = $__DB->fetch_assoc($query)) {
                                    ...
                                    echo '<td>' . '<a href="' . $site_url .'/ipicklist-location/' . $result['idx'] . '/modify"><i class="fa indicator-mn fa-edit col-md-6" style="color: yellow!important;"></i></a><a href="' . $site_url .'/picklist-locations/' . $result['idx'] . '/deactivate"><i class="fa indicator-mn fa-trash col-md-6" style="color: red!important;"></i></a>' . '</td>';
                                    echo '</tr>';
                                }
                                ?>
                                </tbody>
                            ...
                            <a href="/ipicklist-location"><button class="btn btn-block btn-warning">Add New</button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">New Pick List location</h4>
            </div>
