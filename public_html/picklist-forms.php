...
if(isset($_GET['idx']) && $_GET['action']) { //destroy form
    if($_GET['action'] == 'deactivate'){
        $data = array('idx' => (int)$_GET['idx']);
        $data['status'] = 9;
        $upsert = $__PICKLIST->upsertCustomForm($data);
        if($upsert['success']) {
        ...
        header('Location: ' . $site_url . '/picklist-forms/res/'.$success.'/'.$entr);
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Forms</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="sparkline13-list shadow-reset">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Picklist <span class="table-project-n"> Custom Forms</span></h1>
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tr>
                                    ...
                                    <th data-field="formname" data-editable="true">form Name</th>
                                ...
                                <tbody>
                                <?php
                                $query = $__DB->select($_CLASSES['TABLES']['picklistCustomForm'], '`*`', '`status` = 0', 'updatedAt DESC');
                                while ($result = $__DB->fetch_assoc($query)) {
                                    ...
                                    echo '<td>' . '<a href="' . $site_url .'/ipicklist-form/' . $result['idx'] . '/modify"><i class="fa indicator-mn fa-edit col-md-6" style="color: yellow!important;"></i></a><a href="' . $site_url .'/picklist-forms/' . $result['idx'] . '/deactivate"><i class="fa indicator-mn fa-trash col-md-6" style="color: red!important;"></i></a>' . '</td>';
                                    echo '</tr>';
                                }
                                ?>
                                </tbody>
                            ...
                            <a href="/ipicklist-form"><button class="btn btn-block btn-warning">Add New</button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">New Pick List form</h4>
            </div>
