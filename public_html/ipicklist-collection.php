...
if (isset($_POST['name']) && isset($_POST['description'])) {
    $success = '';
    $entr = '';
    $upsert = $__PICKLIST->upsertCollection($_POST);
    if($upsert['success']) {
...
if(isset($_GET['idx']) && isset($_GET['action']) && $_GET['action'] == 'modify') {
    ...
    $query = $__DB->select($_CLASSES['TABLES']['picklistCollection'], '*', 'idx = ' . $idx .' AND status = 0', null, 1);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Collection</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <form action="" id="loginForm" method="post">
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Collection Name</label>
                                                    </div>
                                                    <div class="col-lg-9">
